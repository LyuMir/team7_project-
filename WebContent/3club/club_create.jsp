	...
	<main>
		...
		<form class="" action="create.club" method="post" id="club_creator_form">
				...
				<tr>
					...
					<td>
						<span class="radioColor">
							<input type="radio" name="club_memberJoin" id="r1" value="공개 모집">
							<label for="r1">공개 모집 	</label>
						</span>
						<input type="radio" name="club_memberJoin" id="r2" value="제한 모집"> 	
						<label for="r2">공개 제한모집 </label>
						<input type="radio" name="club_memberJoin" id="r3" value="초대 모집"> 
						<label for="r3">초대 모집 		</label>
						<input type="radio" name="club_memberJoin" id="r4" value="모집 중단"> 
						<label for="r4">모집 중단 		</label>
						<div id="meeting_memGet">
							<span class="no_displ">멤버를 제한없이 모집합니다. </span>
							<span class="no_displ">멤버를 <input type="" name="club_memLimit" style="width: 30px; height:20px;">명 까지 모집하고, 그 후에는 모집을 중단합니다. </span>
							<span class="no_displ">모임의 초대권을 가진 사람만 멤버를 초대할 수 있습니다. </span>
							<span class="no_displ">현재 멤버를 더 모집하지 않습니다. </span>
							<!-- <span>선택하세요. </span> -->
						</div>
						<!-- <span id="meeting_memGet1">
				...
				<tr>
					<td>운동종류 </td>
					<td>
						<!-- <input type="text" name="club_exc_type" placeholder=",로 구분하며 여러개 작성"> -->
				...
				<tr>
					<td>정기모임 <br> 요일 및 시간</td>
					<td>
						<select name="meetingDate_select" id="meetingDate_select">
							<option>선택하세요. </option>
							<option value="meeting1">매주 @요일</option>
							<option value="meeting2">매 @번째 주 @요일</option>
							<option value="meeting3">매달 @번째 @요일</option>
						</select>&emsp;||
						<span id="meetingDate_week">
							<!-- 여기 텍스트 html로 전부 
							예 ) 매주 input 요일.
							 -->
							&emsp; &emsp;
						</span>||&emsp;
						<input type="hidden" name="club_date" id="meetingDate_sender">
						<!-- <div class="checkme"><input type="checkbox" name=""> -->
						<!-- <input class="small_input" type="text" name="">시 ~ 
						<input class="small_input" type="" name=""> 시 -->
						<select name="club_hour1">
							<option>1</option>
							<option>2</option>
							<option>3</option>
							<option>4</option>
				...
				<tr>
					<td>정기모임 장소</td>
					<td>
						<select name='club_area' onchange="areaSelector(this)" >
