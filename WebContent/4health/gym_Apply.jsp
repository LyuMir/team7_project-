...
Security
Insights
team7_project-/WebContent/4health/gym_Apply.jsp

Administrator 0810 _ 헬스장, 트레이너의 사진 & 헬스장, 트레이너의 후기
Latest commit e10b2db on 10 Aug 2020
 History
 0 contributors
316 lines (225 sloc)  11.3 KB
...
*본 상호명을 입력해주세요<br>
<input type="textfield" name="gname" ><br>
...
<input type="text" name="gphone" > <br><br>
	<div class="check_font" id="phonecheck"></div>



<span class="question"> 헬스장 홈페이지 & SNS 주소 <br></span>
<input type="text" name="gpage"  placeholder="aaaa@aaa.com"> <br><br>
...
<input type="checkbox" name="gtype" value="24시">24시
<input type="checkbox" name="gtype" value="샤워">샤워
<input type="checkbox" name="gtype" value="운동복">운동복
<input type="checkbox" name="gtype" value="G.X">G.X
<input type="checkbox" name="gtype" value="웨이트">웨이트
<input type="checkbox" name="gtype" value="필라테스">필라테스
<input type="checkbox" name="gtype" value="스피닝">스피닝
<input type="checkbox" name="gtype" value="복싱">복싱
<input type="checkbox" name="gtype" value="줌바">줌바
<input type="checkbox" name="gtype" value="폴댄스">폴댄스
...
● 1개월권 　 <input type="textfield" name="oneprice"size="10px" placeholder="1만원"> W<br>
● 3개월권  　<input type="textfield" name="threeprice"size="10px" placeholder="3만원"> W<br>
● 6개월권 　 <input type="textfield" name="sixprice"size="10px" placeholder="6만원"> W<br>
●12개월권　<input type="textfield" name="yearprice"size="10px" placeholder="12만원"> W<br>
