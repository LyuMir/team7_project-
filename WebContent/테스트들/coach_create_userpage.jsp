...
<span class="question"> 미팅 가능 일시<br></span>
* 홈핏팀과의 1회 대면 미팅 후에 정식으로 활동이 가능합니다. 미팅 가능한 요일 및 시간을 말씀해주세요.<br>
* 미팅은 홈핏 운영 시간 내에 진행됩니다. (운영시간: 평일 9:30~18:30)<br>
<input type="textfield" name="coachtime" size="50px"> 
...
<span class="question"> 어떤 분들을 가장 잘 코칭 할 수 있으세요?<br></span>
...
<span class="question"> 데일리헬스 코치 지원동기<br></span>
* 홈핏 코치는 전문성을 바탕으로 체계적으로 회원님의 건강을 케어하는 일이기 때문에 열정과 책임감을 가지셔야 합니다.<br>
* 왜 홈핏 코치가 되고 싶은지 적어주세요.<br>
